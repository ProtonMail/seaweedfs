	...
	testCases := []struct {
		...
		},
		{
			...
			wantErrs: []error{
				...
				fmt.Errorf("data file for volume 0 is smaller (0) than the 27 needles it contains (942856)"),
			},
		},
		{
			...
			want:      0,
			wantErrs: []error{
				fmt.Errorf("data file size for volume 0 (942856) doesn't match the size for 0 needles read (0)"),
			},
		},
		{
			name:      "bitrot volume",
